...
public class ProfileSettingsActivity extends AppCompatActivity {
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText passwordEditText, final EditText addressEditText)
    {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    if (dataSnapshot.child("image").exists())
                    {
                        ...
                        passwordEditText.setText(phone);
